...
plot(hpc1$date_time,hpc1$Voltage,type="l",xlab='datetime',ylab = 'Voltage')
...
par(new=F)
plot(hpc1$date_time,hpc1$Global_reactive_power,type="l",xlab='datetime',ylab = 'Global_reactive_power')
dev.off()
